...
extension TrackBlueprint {
    ...
    /// so all seven locked layouts stay valid to the centimetre.
    ///
...
extension CarDesign {
    ...
    static let bodyShop: [(name: String, model: String, symbol: String)] = [
        ...
        ("Pickup Truck", "truck", "truck.pickup.side.fill"),
        ...
        ("Big Rig", "vehicle-truck", "truck.box.fill"),
...
extension DriverProfile {
    ...
    private static func preset(_ n: Int, _ name: String, body: BodyType, skin: String,
                               hair: HairStyle, hairColor: String, eyes: String,
        ...
        DriverProfile(id: UUID(uuidString: String(format: "DA900000-0000-0000-0000-%012d", n))!,
                      ...
                      hatColorHex: hatColor, glasses: glasses, bodyType: body)
    }
}
