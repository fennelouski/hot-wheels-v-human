...
nonisolated enum RacePhase: String, Codable, Sendable {
    case lobby
...
nonisolated struct CarSnapshot: Codable, Equatable, Sendable {
    var playerID: UUID
...
nonisolated struct RaceSnapshot: Codable, Equatable, Sendable {
